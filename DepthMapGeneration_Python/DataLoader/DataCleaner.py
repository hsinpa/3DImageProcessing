...
indoorFolders = loader.GetAllFolderNameFromPath(testPath_1)
...
allFolders = indoorFolders

for path in allFolders:
    colorPath = GetImageFromPath(testPath_1 + path + "/color/", valid_images)
    depthPath = GetImageFromPath(testPath_1 + path + "/depth_vi/", valid_images)
